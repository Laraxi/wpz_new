...
define('CORE_PATH', ROOT_PATH.'source/');
	...
	if (!isset($_POST["out_trade_no"]))
	{
		...
		elseif($orderQueryResult["result_code"] == "FAIL"){
			...
			$money=$orderQueryResult['total_fee'];
			$trade_status="wx";
			//查询并同步订单状态
			 ...
			 $DB->update($table, array('trade_status' => $trade_status, 'trade_no'=>$transaction_id,'cons_score' => $score, 'cons_status' => 4, 'cons_time' => time()), $where);
